<%-- 
    ...
    Created on : 21-Oct-2016, 09:03:14
    Author     : int303
--%>
...
<html>
    <head>
        ...
        <title>Product Listing : JSP Page</title>
        ...
        <script>
            function changeSearchText() {
                ...
                if (selectedValue === 'price') {
                    ...
                    txt1.type = 'number';
                    txt1.min = 0;
                    label.innerHTML = '&nbsp; Enter Price Range : &nbsp;';
                } else if (selectedValue === 'name') {
                    txt2.hidden = true;
                    txt1.type = 'text';
                    txt1.size = '50';
                    label.innerHTML = '&nbsp; Enter Product Name/Type : &nbsp;';
                } else {
                    txt2.hidden = true;
                    txt1.type = 'number';
                    txt1.min = 0;
                    txt1.size = '10';
                    label.innerHTML = '&nbsp; Enter Product ID : &nbsp;';
                }
            }
        </script>

        <jsp:include page="/WEB-INF/jsp/Header.jsp?title=G3: P R O D U C T - L I S T I N G :::"/>
        <br>
            ...
            <form action="AddToCart" method="get" >
                <c:choose>
                    <c:when test ="${param.viewBy=='column'}">
                        <table class="table" style="width:95%;margin-left:35px">
