...
public class EchoServlet extends HttpServlet {
    ...
    public void init() throws ServletException {              
        ...
        tmp = getInitParameter("fontColor");
        if(color != null){
            this.color = tmp;
        }
    }
    ...
    @Override
    public void destroy(){
        System.out.println("I am die "+ new java.util.Date());
    }
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         out.println("<body style = 'background-color:"+bgColor+"; color:"+color+";'> <h2>You have enter</h2>");
